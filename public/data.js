const TFT_DATA = {
    champions: [
        { id: "yi", name: "마스터 이", cost: 4, traits: ["우주 신", "난동꾼"], img: "https://ddragon.leagueoflegends.com/cdn/14.9.1/img/champion/MasterYi.png" },
        { id: "kaisa", name: "카이사", cost: 4, traits: ["우주 그루브", "정찰대"], img: "https://ddragon.leagueoflegends.com/cdn/14.9.1/img/champion/Kaisa.png" },
        { id: "urgot", name: "우르곳", cost: 3, traits: ["조정자", "난동꾼"], img: "https://ddragon.leagueoflegends.com/cdn/14.9.1/img/champion/Urgot.png" },
        ...
        { id: "ezreal", name: "이즈리얼", cost: 3, traits: ["우주 그루브", "요술사"], img: "https://ddragon.leagueoflegends.com/cdn/14.9.1/img/champion/Ezreal.png" },
        ...
        { id: "nami", name: "나미", cost: 2, traits: ["우주 그루브", "수호자"], img: "https://ddragon.leagueoflegends.com/cdn/14.9.1/img/champion/Nami.png" }
    ],
    traits: {
        "우주 신": { levels: [3, 5, 7], desc: "우주 신의 축복을 받아 능력치가 상승합니다." },
        "우주 그루브": { levels: [2, 4, 6], desc: "그루브 리듬에 맞춰 공격 속도가 증가합니다." },
    ...
    decks: [
        ...
        { 
            ...
            description: "우르곳의 탱킹력과 조정자의 보조 피해를 활용합니다." 
        }
    ]
};
